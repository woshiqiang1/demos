...
//AMD定义模块
define('com/carousel-module',['jquery'],function($){
...
define('com/waterfall-module',['jquery'],function($){
    ...
    WaterfallLayout.prototype = {
        ...
        waterfallPlace: function(){
            ...
            this.$container.find($('li')).each(function () {
                ...
                _this.$button.css({left: 575, top: _this.hightCountArray[_this.index] + 800})
            })
            for (var i = 0;i < _this.picColumn; i++){
                _this.hightCountArray[i] = 0;
            }
        ...
        bind: function(){
            ...
            this.$button.on('click',function(){
                ...
                _this.$imgs.load(function(){_this.waterfallPlace()})
            })
        },
        getPic: function(){
            this.htmls = '';
...
;
define('com/gotop-module',['jquery'],function ($) {
...
;
define('app/index',['jquery','com/carousel-module','com/waterfall-module','com/gotop-module'],function($,ActiveCarousel,WaterfallLayout,GoTop){
